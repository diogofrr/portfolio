    ...
    <section className="profile-section">
      ...
      <div className="profile-section__texto">
        ...
        <p>
          ...
          survived not only five centuries, but also the leap into electronic typesetting, remaining remaining
          essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets sheets containing
